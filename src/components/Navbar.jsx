        ...
        <div className="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
          ...
          >
            <div className="text-black dark:text-white lg:pr-4 lg:w-auto w-full lg:pt-0">
              <ul className="tracking-wide font-normal lg:text-lg flex-col flex justify-center items-center lg:flex-row gap-6 lg:gap-0">
                <li>
                  <a
                    href="#aboutus"
            ...
            <div className="flex justify-center items-center m-2">
              <button
                ...
                className="text-slate-500 hover:text-amber-500 rounded-full transition-colors focus:ring-2 focus:ring-offset-1 focus:ring-slate-200"
              >
                {theme === "light" ? (
                  <svg
